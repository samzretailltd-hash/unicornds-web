      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-invert max-w-none text-[#c4c0e0] leading-relaxed space-y-6">
          ...
          <div className="bg-[#1E1B4B]/50 border border-[#7C3AED]/30 rounded-xl p-6 mt-8">
            ...
            <p className="text-sm text-[#a5a0cc] mb-4">List hundreds of products with Bulk Lister, find winners with Product Hunter, and grow your store faster. Simple monthly pricing, cancel anytime.</p>
