...
export const metadata: Metadata = {
  ...
  description: "Install UnicornDS Chrome extension free. Start eBay dropshipping with Amazon & AliExpress in minutes. 7-day trial from just £1 on every plan. £1 trial activation fee..",
  ...
  openGraph: {
    ...
    description: "Install in under 2 minutes. 7-day trial from just £1, card verified.",
