...
export const metadata: Metadata = {
  ...
  description: "Install UnicornDS Chrome extension free. Start eBay dropshipping with Amazon & AliExpress in minutes. 14-day trial, 100 listings, no credit card.",
  ...
  openGraph: {
    ...
    description: "Install in under 2 minutes. Free trial, no credit card.",
