...
const sections = [
  {
    ...
    items: [
      { title: "Create Your Account", content: "Go to unicornds.io/signup. Enter your full name, email, and password. Your 7-day trial for just £1 starts immediately with full access — AI titles, Product Hunter, and VERO protection." },
