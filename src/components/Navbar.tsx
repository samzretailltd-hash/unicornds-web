    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0f0e1a]/85 backdrop-blur-xl border-b border-[#3d3580]/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center">
        ...
        <div className="hidden lg:flex items-center gap-6 ml-auto">
          ...
          <Link href="/ebay-fees-calculator" className="text-sm text-[#10B981] hover:text-white transition-colors font-bold">🧮 Free Calculator</Link>
      ...
      {open && (
        <div className="lg:hidden bg-[#0f0e1a] border-b border-[#3d3580] px-4 py-4 flex flex-col gap-1">
          ...
          <Link href="/ebay-fees-calculator" onClick={close} className="text-[15px] text-[#10B981] hover:text-white py-3 px-3 rounded-lg hover:bg-[#1E1B4B]/50 font-bold">🧮 eBay Fees Calculator</Link>
